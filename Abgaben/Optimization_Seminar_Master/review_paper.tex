...
% TODO: Introduce the concept of "sufficient decrease" (Armijo) and "curvature"
...
% TODO: Add images for Armijo and Wolfe conditions from the presentation as well

\subsection{Inexact Line Search Algorithm}
% TODO: Present a simple pseudo-code for inexact line search using Armijo-Wolfe
% TODO: Write the same algorithm as in the presentation

% TODO: Elaborate why inexact line search works for non-smooth functions
